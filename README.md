...
- 「全部まとめて入れ替える」を選ぶと、変えるスロットを自由に選べます（Rod / Line / Bobber / Enchant から 1 つ以上）。
...
- 変えるスロットは画面の「変えるスロットを選ぶ」トグルで切り替えられます。現在の選択はチップ表示で常に確認できます。
...
4. **次に、比べる欄を選ぶ**: `Rod / Line / Bobber / Enchant` から 1 欄ずつ、または `全部まとめて入れ替える` / `カスタム組み合わせ` から複数スロットを同時に探せます。
